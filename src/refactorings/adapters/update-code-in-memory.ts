...
export { createWriteInMemory, createWriteInMemoryOn };

function createWriteInMemory(codeMatrix: CodeMatrix): Write {
  return updates => {
...
function createWriteInMemoryOn(code: Code): [Write, () => Code] {
  ...
  return [
    createWriteInMemory(codeMatrix),
    () =>
      codeMatrix
